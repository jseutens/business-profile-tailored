	...
	function bpwfwp_print_contact_card( $args = array() ) {
		...
		$data = apply_filters(
			...
			array(
				...
				'cellphone'               => 'bpwfwp_print_cellphone',
				'fax'               => 'bpwfwp_print_fax',
...
if ( ! function_exists( 'bpwfwp_print_cellphone' ) ) {
	/**
	 * Print the cellphone number.
	 *
	 * @since  0.0.1
	 * @access public
	 * @param  string $location The location associated with the cellphone.
	 * @return array
	 */
	function bpwfwp_print_cellphone( $location = false ) {

		$return_data = array();

		$cellphone = bpfwp_setting( 'cellphone', $location );
		$click_to_call_cellphone = bpfwp_setting( 'cellphone', $location );
		if ( empty( $cellphone ) ) {
			return '';
		}

		if ( bpfwp_get_display( 'show_cellphone' ) ) : ?>

		<div class="bp-cellphone">
			<a href="tel:<?php echo esc_attr( $click_to_call_cellphone ); ?>"><?php echo esc_html( bpfwp_setting( 'cellphone', $location ) ); ?></a>
		</div>

		<?php endif;

		$return_data['telephone'] = bpfwp_setting( 'cellphone', $location );
...
if ( ! function_exists( 'bpwfwp_print_fax' ) ) {
	 ...
	 * @since  0.0.1
	 * @access public
	 * @param  string $location The location associated with the fax.
	 * @return array
	 */
	function bpwfwp_print_fax( $location = false ) {
		...
		$click_to_call_fax = bpfwp_setting( 'fax', $location );
		if ( empty( $fax ) ) {
			return '';
		}
		...
		<div class="bp-fax">
			<a href="tel:<?php echo esc_attr( $click_to_call_fax ); ?>"><?php echo esc_html( bpfwp_setting( 'fax', $location ) ); ?></a>
		</div>

		<?php endif;

		$return_data['telephone'] = bpfwp_setting( 'fax', $location );
