...
if ( ! class_exists( 'bpfwpCustomPostTypes', false ) ) :
	...
	class bpfwpCustomPostTypes {
		...
		public function print_contact_metabox( $post ) {
			...
			<div class="bpfwp-meta-input bpfwp-meta-cellphone">
				<label for="bpfwp_cellphone">
					<?php esc_html_e( 'Cellphone Number', 'business-profile' ); ?>
				</label>
				<input type="tel" name="cellphone" id="bpfwp_cellphone" value="<?php esc_attr_e( get_post_meta( $post->ID, 'cellphone', true ) ); ?>">
			</div>

			<div class="bpfwp-meta-input bpfwp-meta-fax">
				<label for="bpfwp_fax">
					<?php esc_html_e( 'Fax Number', 'business-profile' ); ?>
				</label>
